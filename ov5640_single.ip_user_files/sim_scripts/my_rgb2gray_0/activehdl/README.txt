...
#
# Generated by export_simulation on Tue Dec 19 11:39:03 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './my_rgb2gray_0.sh' script.

./my_rgb2gray_0.sh -reset_run
...
./my_rgb2gray_0.sh -noclean_files

For more information on the script, please type './my_rgb2gray_0.sh -help'.
