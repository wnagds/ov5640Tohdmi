...
wire   [0:0] exitcond2_i_fu_412_p2;
...
wire   [11:0] t_V_2_cast_i_fu_423_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_i_fu_412_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_427_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_i_fu_412_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((exitcond2_i_fu_412_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign exitcond2_i_fu_412_p2 = ((t_V_cast_i_fu_408_p1 == img_rows_V_read_reg_479) ? 1'b1 : 1'b0);

assign exitcond_i_fu_427_p2 = ((t_V_2_cast_i_fu_423_p1 == img_cols_V_read_reg_484) ? 1'b1 : 1'b0);
...
assign j_V_fu_432_p2 = (t_V_2_reg_284 + 11'd1);

assign src_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign start_out = real_start;

assign t_V_2_cast_i_fu_423_p1 = t_V_2_reg_284;
