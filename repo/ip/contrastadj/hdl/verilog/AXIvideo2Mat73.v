...
reg   [0:0] exitcond_i_i_reg_406;
reg   [0:0] brmerge_i_i_reg_415;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_i_i_reg_258;
reg    img_data_stream_0_V_blk_n;
reg    img_data_stream_1_V_blk_n;
reg    img_data_stream_2_V_blk_n;
reg    adj_out_blk_n;
reg   [10:0] t_V_2_reg_188;
reg   [0:0] eol_i_i_reg_199;
reg   [0:0] eol_reg_211;
reg   [23:0] axi_data_V_1_i_i_reg_222;
reg   [0:0] axi_last_V_3_i_i_reg_269;
reg   [23:0] axi_data_V_3_i_i_reg_281;
reg   [23:0] tmp_data_V_reg_377;
reg   [0:0] tmp_last_V_reg_385;
wire   [0:0] exitcond2_i_i_fu_312_p2;
wire    ap_CS_fsm_state4;
wire   [10:0] i_V_fu_318_p2;
reg   [10:0] i_V_reg_401;
wire   [0:0] exitcond_i_i_fu_324_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_predicate_op122_read_state6;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [10:0] j_V_fu_330_p2;
...
reg   [0:0] ap_phi_mux_eol_2_i_i_phi_fu_261_p4;
reg   [0:0] axi_last_V1_i_i_reg_157;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [23:0] axi_data_V1_i_i_reg_167;
reg   [10:0] t_V_reg_177;
reg   [0:0] ap_phi_mux_eol_i_i_phi_fu_203_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_i_phi_fu_238_p4;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_250_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_i_reg_233;
wire   [23:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_246;
reg    ap_block_state1;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_i_fu_100;
wire   [0:0] tmp_user_V_fu_303_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
reg    ap_idle_pp2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_i_i_fu_312_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_i_fu_324_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_i_i_fu_312_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_phi_mux_eol_2_i_i_phi_fu_261_p4 == 1'd1) & (1'b0 == ap_block_pp2_stage0_subdone) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_i_reg_406 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((eol_2_i_i_reg_258 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_i_fu_324_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_i_fu_100 <= 1'd0;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        sof_1_i_i_fu_100 <= 1'd1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_i_fu_324_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_i_i_reg_258 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op122_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond2_i_i_fu_312_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_512)) begin
        if ((brmerge_i_i_reg_415 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_i_phi_fu_238_p4 = eol_reg_211;
        end else if ((brmerge_i_i_reg_415 == 1'd0)) begin
...
always @ (*) begin
    if (((eol_2_i_i_reg_258 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_i_reg_406 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_i_reg_258 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_i_reg_415 == 1'd0) & (exitcond_i_i_reg_406 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_303_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_303_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op122_read_state6 == 1'b1)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op122_read_state6 == 1'b1)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op122_read_state6 == 1'b1)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_i_i_reg_258 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_i_i_reg_258 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op122_read_state6 == 1'b1)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_i_reg_406 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_i_i_reg_258 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_512 = ((exitcond_i_i_reg_406 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_i_reg_233 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_246 = 'bx;

always @ (*) begin
    ap_predicate_op122_read_state6 = ((brmerge_i_i_reg_415 == 1'd0) & (exitcond_i_i_reg_406 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_i_fu_339_p2 = (sof_1_i_i_fu_100 | ap_phi_mux_eol_i_i_phi_fu_203_p4);

assign exitcond2_i_i_fu_312_p2 = ((t_V_reg_177 == 11'd1080) ? 1'b1 : 1'b0);

assign exitcond_i_i_fu_324_p2 = ((t_V_2_reg_188 == 11'd1920) ? 1'b1 : 1'b0);

assign i_V_fu_318_p2 = (t_V_reg_177 + 11'd1);

assign img_data_stream_0_V_din = ap_phi_mux_p_Val2_s_phi_fu_250_p4[7:0];

assign img_data_stream_1_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_250_p4[15:8]}};

assign img_data_stream_2_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_250_p4[23:16]}};

assign j_V_fu_330_p2 = (t_V_2_reg_188 + 11'd1);

assign src_axi_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign start_out = real_start;

assign tmp_user_V_fu_303_p1 = AXI_video_strm_V_user_V_0_data_out;

endmodule //AXIvideo2Mat73
