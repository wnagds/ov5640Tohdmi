...
architecture behav of contrastadj is 
    ...
    "contrastadj,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-2,HLS_INPUT_CLOCK=6.666667,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.275000,HLS_SYN_LAT=2124372,HLS_SYN_TPT=2124362,HLS_SYN_MEM=3,HLS_SYN_DSP=107,HLS_SYN_FF=26371,HLS_SYN_LUT=35355}";
    ...
    signal AXIvideo2Mat73_U0_ap_start : STD_LOGIC;
    signal AXIvideo2Mat73_U0_start_full_n : STD_LOGIC;
    signal AXIvideo2Mat73_U0_ap_done : STD_LOGIC;
    signal AXIvideo2Mat73_U0_ap_continue : STD_LOGIC;
    signal AXIvideo2Mat73_U0_ap_idle : STD_LOGIC;
    signal AXIvideo2Mat73_U0_ap_ready : STD_LOGIC;
    signal AXIvideo2Mat73_U0_start_out : STD_LOGIC;
    signal AXIvideo2Mat73_U0_start_write : STD_LOGIC;
    signal AXIvideo2Mat73_U0_src_axi_TREADY : STD_LOGIC;
    signal AXIvideo2Mat73_U0_img_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat73_U0_img_data_stream_0_V_write : STD_LOGIC;
    signal AXIvideo2Mat73_U0_img_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat73_U0_img_data_stream_1_V_write : STD_LOGIC;
    signal AXIvideo2Mat73_U0_img_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat73_U0_img_data_stream_2_V_write : STD_LOGIC;
    signal AXIvideo2Mat73_U0_adj_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal AXIvideo2Mat73_U0_adj_out_write : STD_LOGIC;
...
begin
    ...
    AXIvideo2Mat73_U0 : component AXIvideo2Mat73
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    AXIvideo2Mat73_U0_ap_continue <= ap_const_logic_1;
    AXIvideo2Mat73_U0_ap_start <= ap_start;
    AXIvideo2Mat73_U0_start_full_n <= (start_for_dualAryEqualize_U0_full_n and start_for_Cvt_RGB_to_YCrCb_U0_full_n);
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (dualAryEqualize_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Cvt_YCrCb_to_RGB_U0_ap_idle and Cvt_RGB_to_YCrCb_U0_ap_idle and AXIvideo2Mat73_U0_ap_idle);
    ap_ready <= AXIvideo2Mat73_U0_ap_ready;
    ...
    ap_sync_ready <= AXIvideo2Mat73_U0_ap_ready;
    dst_axi_TDATA <= Mat2AXIvideo_U0_dst_axi_TDATA;
    dst_axi_TDEST <= Mat2AXIvideo_U0_dst_axi_TDEST;
    dst_axi_TID <= Mat2AXIvideo_U0_dst_axi_TID;
    dst_axi_TKEEP <= Mat2AXIvideo_U0_dst_axi_TKEEP;
