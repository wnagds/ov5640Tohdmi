...
architecture behav of img_filter is 
    ...
    "img_filter,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-2,HLS_INPUT_CLOCK=6.666660,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.833327,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=13,HLS_SYN_FF=4841,HLS_SYN_LUT=9363}";
    ...
    signal Block_proc127_U0_ap_start : STD_LOGIC;
    signal Block_proc127_U0_ap_done : STD_LOGIC;
    signal Block_proc127_U0_ap_continue : STD_LOGIC;
    signal Block_proc127_U0_ap_idle : STD_LOGIC;
    signal Block_proc127_U0_ap_ready : STD_LOGIC;
    signal Block_proc127_U0_start_out : STD_LOGIC;
    signal Block_proc127_U0_start_write : STD_LOGIC;
    signal Block_proc127_U0_srcImg_rows_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal Block_proc127_U0_srcImg_rows_V_out_write : STD_LOGIC;
    signal Block_proc127_U0_srcImg_cols_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal Block_proc127_U0_srcImg_cols_V_out_write : STD_LOGIC;
    signal Block_proc127_U0_threshold_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Block_proc127_U0_threshold_out_write : STD_LOGIC;
    ...
    signal Filter2D88_U0_ap_start : STD_LOGIC;
    signal Filter2D88_U0_ap_done : STD_LOGIC;
    signal Filter2D88_U0_ap_continue : STD_LOGIC;
    signal Filter2D88_U0_ap_idle : STD_LOGIC;
    signal Filter2D88_U0_ap_ready : STD_LOGIC;
    signal Filter2D88_U0_start_out : STD_LOGIC;
    signal Filter2D88_U0_start_write : STD_LOGIC;
    signal Filter2D88_U0_p_src_data_stream_V_read : STD_LOGIC;
    signal Filter2D88_U0_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Filter2D88_U0_p_dst_data_stream_V_write : STD_LOGIC;
    ...
    signal binary_filter_gray_i_U0_ap_start : STD_LOGIC;
    signal binary_filter_gray_i_U0_ap_done : STD_LOGIC;
    signal binary_filter_gray_i_U0_ap_continue : STD_LOGIC;
    signal binary_filter_gray_i_U0_ap_idle : STD_LOGIC;
    signal binary_filter_gray_i_U0_ap_ready : STD_LOGIC;
    signal binary_filter_gray_i_U0_start_out : STD_LOGIC;
    signal binary_filter_gray_i_U0_start_write : STD_LOGIC;
    signal binary_filter_gray_i_U0_p_src_data_stream_V_read : STD_LOGIC;
    signal binary_filter_gray_i_U0_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal binary_filter_gray_i_U0_p_dst_data_stream_V_write : STD_LOGIC;
    signal binary_filter_gray_i_U0_threshold_read : STD_LOGIC;
    ...
    signal grads_img_data_strea_full_n : STD_LOGIC;
    signal grads_img_data_strea_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal grads_img_data_strea_empty_n : STD_LOGIC;
    signal detected_img_data_st_full_n : STD_LOGIC;
    signal detected_img_data_st_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal detected_img_data_st_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_Block_proc127_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_proc127_U0_ap_ready : STD_LOGIC;
    signal Block_proc127_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal start_for_binary_filter_gray_i_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_binary_filter_gray_i_U0_full_n : STD_LOGIC;
    signal start_for_binary_filter_gray_i_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_binary_filter_gray_i_U0_empty_n : STD_LOGIC;
    ...
    signal start_for_Filter2D88_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Filter2D88_U0_full_n : STD_LOGIC;
    signal start_for_Filter2D88_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Filter2D88_U0_empty_n : STD_LOGIC;
    ...
    component binary_filter_gray_i IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component start_for_binary_pcA IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component img_filter_AXILiteS_s_axi IS
    generic (
...
begin
    img_filter_AXILiteS_s_axi_U : component img_filter_AXILiteS_s_axi
    generic map (
    ...
    Block_proc127_U0 : component Block_proc127
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Filter2D88_U0 : component Filter2D88
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    binary_filter_gray_i_U0 : component binary_filter_gray_i
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grads_img_data_strea_U : component fifo_w8_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    detected_img_data_st_U : component fifo_w8_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_binary_pcA_U : component start_for_binary_pcA
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_Block_proc127_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Block_proc127_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Block_proc127_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    Block_proc127_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Block_proc127_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Block_proc127_U0_ap_ready_count <= std_logic_vector(unsigned(Block_proc127_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = Block_proc127_U0_ap_ready))) then 
                Block_proc127_U0_ap_ready_count <= std_logic_vector(unsigned(Block_proc127_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_proc127_U0_ap_continue <= ap_const_logic_1;
    Block_proc127_U0_ap_start <= ((ap_sync_reg_Block_proc127_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    Duplicate_U0_start_full_n <= (start_for_Filter2D_U0_full_n and start_for_Filter2D88_U0_full_n);
    Filter2D88_U0_ap_continue <= ap_const_logic_1;
    Filter2D88_U0_ap_start <= start_for_Filter2D88_U0_empty_n;
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (binary_filter_gray_i_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Filter2D_U0_ap_idle and Filter2D88_U0_ap_idle and Duplicate_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and Block_proc127_U0_ap_idle and AddWeighted_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ...
    ap_sync_Block_proc127_U0_ap_ready <= (ap_sync_reg_Block_proc127_U0_ap_ready or Block_proc127_U0_ap_ready);
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= Mat2AXIvideo_U0_ap_done;
    ap_sync_ready <= (ap_sync_Block_proc127_U0_ap_ready and ap_sync_AXIvideo2Mat_U0_ap_ready);
    binary_filter_gray_i_U0_ap_continue <= ap_const_logic_1;
    binary_filter_gray_i_U0_ap_start <= start_for_binary_filter_gray_i_U0_empty_n;
    dst_TDATA <= Mat2AXIvideo_U0_dst_TDATA;
    dst_TDEST <= Mat2AXIvideo_U0_dst_TDEST;
    dst_TID <= Mat2AXIvideo_U0_dst_TID;
    dst_TKEEP <= Mat2AXIvideo_U0_dst_TKEEP;
    ...
    start_for_Filter2D88_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_Filter2D_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_Mat2AXIvideo_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_binary_filter_gray_i_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
